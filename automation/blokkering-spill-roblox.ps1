...
# 1. Liste med URL'ene du ønsker blokkere (Bruk av Here-String for sikker parsing)
...
# ==========================================================
# 1. URL - Roblox kjente URL'er (Here-String format)
# ==========================================================
$urlTextBlock = @"
...
# Gjør teksten om til en ren liste og fjerner eventuelle tomme mellomrom
$blockedList = $urlTextBlock -split "`n" | ForEach-Object { $_.Trim() } | Where-Object { $_.Length -gt 0 }
